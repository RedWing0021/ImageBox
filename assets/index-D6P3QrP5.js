 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */(function(e){function t(C,O){var x=C.length;C.push(O);e:for(;0<x;){var q=x-1>>>1,te=C[q];if(0<i(te,O))C[q]=O,C[x]=te,x=q;else break e}}function n(C){return C.length===0?null:C[0]}function r(C){if(C.length===0)return null;var O=C[0],x=C.pop();if(x!==O){C[0]=x;e:for(var q=0,te=C.length,ui=te>>>1;q<ui;){var Wt=2*(q+1)-1,ts=C[Wt],Kt=Wt+1,ci=C[Kt];if(0>i(ts,x))Kt<te&&0>i(ci,ts)?(C[q]=ci,C[Kt]=x,q=Kt):(C[q]=ts,C[Wt]=x,q=Wt);else if(Kt<te&&0>i(ci,x))C[q]=ci,C[Kt]=x,q=Kt;else break e}}return O}function i(C,O){var x=C.sortIndex-O.sortIndex;return x!==0?x:C.id-O.id}if(typeof performance=="object"&&typeof performance.now=="function"){var o=performance;e.unstable_now=function(){return o.now()}}else{var s=Date,l=s.now();e.unstable_now=function(){return s.now()-l}}var a=[],u=[],d=1,f=null,m=3,v=!1,y=!1,_=!1,E=typeof setTimeout=="function"?setTimeout:null,h=typeof clearTimeout=="function"?clearTimeout:null,c=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function p(C){for(var O=n(u);O!==null;){if(O.callback===null)r(u);else if(O.startTime<=C)r(u),O.sortIndex=O.expirationTime,t(a,O);else break;O=n(u)}}function g(C){if(_=!1,p(C),!y)if(n(a)!==null)y=!0,Zo(S);else{var O=n(u);O!==null&&es(g,O.startTime-C)}}function S(C,O){y=!1,_&&(_=!1,h(P),P=-1),v=!0;var x=m;try{for(p(O),f=n(a);f!==null&&(!(f.expirationTime>O)||C&&!Fe());){var q=f.callback;if(typeof q=="function"){f.callback=null,m=f.priorityLevel;var te=q(f.expirationTime<=O);O=e.unstable_now(),typeof te=="function"?f.callback=te:f===n(a)&&r(a),p(O)}else r(a);f=n(a)}if(f!==null)var ui=!0;else{var Wt=n(u);Wt!==null&&es(g,Wt.startTime-O),ui=!1}return ui}finally{f=null,m=x,v=!1}}var I=!1,R=null,P=-1,b=5,L=-1;function Fe(){return!(e.unstable_now()-L<b)}function nr(){if(R!==null){var C=e.unstable_now();L=C;var O=!0;try{O=R(!0,C)}finally{O?rr():(I=!1,R=null)}}else I=!1}var rr;if(typeof c=="function")rr=function(){c(nr)};else if(typeof MessageChannel<"u"){var ou=new MessageChannel,Up=ou.port2;ou.port1.onmessage=nr,rr=function(){Up.postMessage(null)}}else rr=function(){E(nr,0)};function Zo(C){R=C,I||(I=!0,rr())}function es(C,O){P=E(function(){C(e.unstable_now())},O)}e.unstable_IdlePriority=5,e.unstable_ImmediatePriority=1,e.unstable_LowPriority=4,e.unstable_NormalPriority=3,e.unstable_Profiling=null,e.unstable_UserBlockingPriority=2,e.unstable_cancelCallback=function(C){C.callback=null},e.unstable_continueExecution=function(){y||v||(y=!0,Zo(S))},e.unstable_forceFrameRate=function(C){0>C||125<C?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):b=0<C?Math.floor(1e3/C):5},e.unstable_getCurrentPriorityLevel=function(){return m},e.unstable_getFirstCallbackNode=function(){return n(a)},e.unstable_next=function(C){switch(m){case 1:case 2:case 3:var O=3;break;default:O=m}var x=m;m=O;try{return C()}finally{m=x}},e.unstable_pauseExecution=function(){},e.unstable_requestPaint=function(){},e.unstable_runWithPriority=function(C,O){switch(C){case 1:case 2:case 3:case 4:case 5:break;default:C=3}var x=m;m=C;try{return O()}finally{m=x}},e.unstable_scheduleCallback=function(C,O,x){var q=e.unstable_now();switch(typeof x=="object"&&x!==null?(x=x.delay,x=typeof x=="number"&&0<x?q+x:q):x=q,C){case 1:var te=-1;break;case 2:te=250;break;case 5:te=1073741823;break;case 4:te=1e4;break;default:te=5e3}return te=x+te,C={id:d++,callback:O,priorityLevel:C,startTime:x,expirationTime:te,sortIndex:-1},x>q?(C.sortIndex=x,t(u,C),n(a)===null&&C===n(u)&&(_?(h(P),P=-1):_=!0,es(g,x-q))):(C.sortIndex=te,t(a,C),y||v||(y=!0,Zo(S))),C},e.unstable_shouldYield=Fe,e.unstable_wrapCallback=function(C){var O=m;return function(){var x=m;m=O;try{return C.apply(this,arguments)}finally{m=x}}}})(vd);gd.exports=vd;var sm=gd.exports;/**
 * @license React
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const wp="firebasestorage.googleapis.com",Ep="storageBucket",Jw=2*60*1e3,Zw=10*60*1e3;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
${this.customData.serverResponse}`:this.message=this._baseMessage}}var G;(function(e){e.UNKNOWN="unknown",e.OBJECT_NOT_FOUND="object-not-found",e.BUCKET_NOT_FOUND="bucket-not-found",e.PROJECT_NOT_FOUND="project-not-found",e.QUOTA_EXCEEDED="quota-exceeded",e.UNAUTHENTICATED="unauthenticated",e.UNAUTHORIZED="unauthorized",e.UNAUTHORIZED_APP="unauthorized-app",e.RETRY_LIMIT_EXCEEDED="retry-limit-exceeded",e.INVALID_CHECKSUM="invalid-checksum",e.CANCELED="canceled",e.INVALID_EVENT_NAME="invalid-event-name",e.INVALID_URL="invalid-url",e.INVALID_DEFAULT_BUCKET="invalid-default-bucket",e.NO_DEFAULT_BUCKET="no-default-bucket",e.CANNOT_SLICE_BLOB="cannot-slice-blob",e.SERVER_FILE_WRONG_SIZE="server-file-wrong-size",e.NO_DOWNLOAD_URL="no-download-url",e.INVALID_ARGUMENT="invalid-argument",e.INVALID_ARGUMENT_COUNT="invalid-argument-count",e.APP_DELETED="app-deleted",e.INVALID_ROOT_OPERATION="invalid-root-operation",e.INVALID_FORMAT="invalid-format",e.INTERNAL_ERROR="internal-error",e.UNSUPPORTED_ENVIRONMENT="unsupported-environment"})(G||(G={}));function Ms(e){return"storage/"+e}function Ya(){const e="An unknown error occurred, please check the error payload for server response.";return new Q(G.UNKNOWN,e)}function eE(e){return new Q(G.OBJECT_NOT_FOUND,"Object '"+e+"' does not exist.")}function tE(e){return new Q(G.QUOTA_EXCEEDED,"Quota for bucket '"+e+"' exceeded, please view quota on https://firebase.google.com/pricing/.")}function nE(){const e="User is not authenticated, please authenticate using Firebase Authentication and try again.";return new Q(G.UNAUTHENTICATED,e)}function rE(){return new Q(G.UNAUTHORIZED_APP,"This app does not have permission to access Firebase Storage on this project.")}function iE(e){return new Q(G.UNAUTHORIZED,"User does not have permission to access '"+e+"'.")}function oE(){return new Q(G.RETRY_LIMIT_EXCEEDED,"Max retry time for operation exceeded, please try again.")}function sE(){return new Q(G.CANCELED,"User canceled the upload/download.")}function lE(e){return new Q(G.INVALID_URL,"Invalid URL '"+e+"'.")}function aE(e){return new Q(G.INVALID_DEFAULT_BUCKET,"Invalid default bucket '"+e+"'.")}function uE(){return new Q(G.NO_DEFAULT_BUCKET,"No default bucket found. Did you set the '"+Ep+"' property when initializing the app?")}function cE(){return new Q(G.CANNOT_SLICE_BLOB,"Cannot slice blob for upload. Please retry the upload.")}function dE(){return new Q(G.NO_DOWNLOAD_URL,"The given file does not have any download URLs.")}function fE(e){return new Q(G.UNSUPPORTED_ENVIRONMENT,`${e} is missing. Make sure to install the required polyfills. See https://firebase.google.com/docs/web/environments-js-sdk#polyfills for more information.`)}function jl(e){return new Q(G.INVALID_ARGUMENT,e)}function Sp(){return new Q(G.APP_DELETED,"The Firebase app was deleted.")}function hE(e){return new Q(G.INVALID_ROOT_OPERATION,"The operation '"+e+"' cannot be performed on a root reference, create a non-root reference using child, such as .child('file.png').")}function Nr(e,t){return new Q(G.INVALID_FORMAT,"String does not match format '"+e+"': "+t)}function fr(e){throw new Q(G.INTERNAL_ERROR,"Internal error: "+e)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class me{constructor(t,n){this.bucket=t,this.path_=n}get path(){return this.path_}get isRoot(){return this.path.length===0}fullServerUrl(){const t=encodeURIComponent;return"/b/"+t(this.bucket)+"/o/"+t(this.path)}bucketOnlyServerUrl(){return"/b/"+encodeURIComponent(this.bucket)+"/o"}static makeFromBucketSpec(t,n){let r;try{r=me.makeFromUrl(t,n)}catch{return new me(t,"")}if(r.path==="")return r;throw aE(t)}static makeFromUrl(t,n){let r=null;const i="([A-Za-z0-9.\\-_]+)";function o(g){g.path.charAt(g.path.length-1)==="/"&&(g.path_=g.path_.slice(0,-1))}const s="(/(.*))?$",l=new RegExp("^gs://"+i+s,"i"),a={bucket:1,path:3};function u(g){g.path_=decodeURIComponent(g.path)}const d="v[A-Za-z0-9_]+",f=n.replace(/[.]/g,"\\."),m="(/([^?#]*).*)?$",v=new RegExp(`^https?://${f}/${d}/b/${i}/o${m}`,"i"),y={bucket:1,path:3},_=n===wp?"(?:storage.googleapis.com|storage.cloud.google.com)":n,E="([^?#]*)",h=new RegExp(`^https?://${_}/${i}/${E}`,"i"),p=[{regex:l,indices:a,postModify:o},{regex:v,indices:y,postModify:u},{regex:h,indices:{bucket:1,path:2},postModify:u}];for(let g=0;g<p.length;g++){const S=p[g],I=S.regex.exec(t);if(I){const R=I[S.indices.bucket];let P=I[S.indices.path];P||(P=""),r=new me(R,P),S.postModify(r);break}}if(r==null)throw lE(t);return r}}class pE{constructor(t){this.promise_=Promise.reject(t)}getPromise(){return this.promise_}cancel(t=!1){}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function mE(e,t,n){let r=1,i=null,o=null,s=!1,l=0;function a(){return l===2}let u=!1;function d(...E){u||(u=!0,t.apply(null,E))}function f(E){i=setTimeout(()=>{i=null,e(v,a())},E)}function m(){o&&clearTimeout(o)}function v(E,...h){if(u){m();return}if(E){m(),d.call(null,E,...h);return}if(a()||s){m(),d.call(null,E,...h);return}r<64&&(r*=2);let p;l===1?(l=2,p=0):p=(r+Math.random())*1e3,f(p)}let y=!1;function _(E){y||(y=!0,m(),!u&&(i!==null?(E||(l=2),clearTimeout(i),f(0)):E||(l=1)))}return f(0),o=setTimeout(()=>{s=!0,_(!0)},n),_}function gE(e){e(!1)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function _E(e,t){const n=e>=500&&e<600,i=[408,429].indexOf(e)!==-1,o=t.indexOf(e)!==-1;return n||i||o}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class wE{constructor(t,n,r,i,o,s,l,a,u,d,f,m=!0){this.url_=t,this.method_=n,this.headers_=r,this.body_=i,this.successCodes_=o,this.additionalRetryCodes_=s,this.callback_=l,this.errorCallback_=a,this.timeout_=u,this.progressCallback_=d,this.connectionFactory_=f,this.retry=m,this.pendingConnection_=null,this.backoffId_=null,this.canceled_=!1,this.appDelete_=!1,this.promise_=new Promise((v,y)=>{this.resolve_=v,this.reject_=y,this.start_()})}start_(){const t=(r,i)=>{if(i){r(!1,new Ni(!1,null,!0));return}const o=this.connectionFactory_();this.pendingConnection_=o;const s=l=>{const a=l.loaded,u=l.lengthComputable?l.total:-1;this.progressCallback_!==null&&this.progressCallback_(a,u)};this.progressCallback_!==null&&o.addUploadProgressListener(s),o.send(this.url_,this.method_,this.body_,this.headers_).then(()=>{this.progressCallback_!==null&&o.removeUploadProgressListener(s),this.pendingConnection_=null;const l=o.getErrorCode()===rn.NO_ERROR,a=o.getStatus();if(!l||_E(a,this.additionalRetryCodes_)&&this.retry){const d=o.getErrorCode()===rn.ABORT;r(!1,new Ni(!1,null,d));return}const u=this.successCodes_.indexOf(a)!==-1;r(!0,new Ni(u,o))})},n=(r,i)=>{const o=this.resolve_,s=this.reject_,l=i.connection;if(i.wasSuccessCode)try{const a=this.callback_(l,l.getResponse());vE(a)?o(a):o()}catch(a){s(a)}else if(l!==null){const a=Ya();a.serverResponse=l.getErrorText(),this.errorCallback_?s(this.errorCallback_(l,a)):s(a)}else if(i.canceled){const a=this.appDelete_?Sp():sE();s(a)}else{const a=oE();s(a)}};this.canceled_?n(!1,new Ni(!1,null,!0)):this.backoffId_=mE(t,n,this.timeout_)}getPromise(){return this.promise_}cancel(t){this.canceled_=!0,this.appDelete_=t||!1,this.backoffId_!==null&&gE(this.backoffId_),this.pendingConnection_!==null&&this.pendingConnection_.abort()}}class Ni{constructor(t,n,r){this.wasSuccessCode=t,this.connection=n,this.canceled=!!r}}function EE(e,t){t!==null&&t.length>0&&(e.Authorization="Firebase "+t)}function SE(e,t){e["X-Firebase-Storage-Version"]="webjs/"+(t??"AppManager")}function kE(e,t){t&&(e["X-Firebase-GMPID"]=t)}function IE(e,t){t!==null&&(e["X-Firebase-AppCheck"]=t)}function TE(e,t,n,r,i,o,s=!0){const l=kp(e.urlParams),a=e.url+l,u=Object.assign({},e.headers);return kE(u,t),EE(u,n),SE(u,o),IE(u,r),new wE(a,e.method,u,e.body,e.successCodes,e.additionalRetryCodes,e.handler,e.errorHandler,e.timeout,e.progressCallback,i,s)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function CE(){return typeof BlobBuilder<"u"?BlobBuilder:typeof WebKitBlobBuilder<"u"?WebKitBlobBuilder:void 0}function RE(...e){const t=CE();if(t!==void 0){const n=new t;for(let r=0;r<e.length;r++)n.append(e[r]);return n.getBlob()}else{if(Ja())return new Blob(e);throw new Q(G.UNSUPPORTED_ENVIRONMENT,"This browser doesn't seem to support creating Blobs")}}function PE(e,t,n){return e.webkitSlice?e.webkitSlice(t,n):e.mozSlice?e.mozSlice(t,n):e.slice?e.slice(t,n):null}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function NE(e){if(typeof atob>"u")throw fE("base-64");return atob(e)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const qe={RAW:"raw",BASE64:"base64",BASE64URL:"base64url",DATA_URL:"data_url"};class Fs{constructor(t,n){this.data=t,this.contentType=n||null}}function OE(e,t){switch(e){case qe.RAW:return new Fs(Ip(t));case qe.BASE64:case qe.BASE64URL:return new Fs(Tp(e,t));case qe.DATA_URL:return new Fs(xE(t),LE(t))}throw Ya()}function Ip(e){const t=[];for(let n=0;n<e.length;n++){let r=e.charCodeAt(n);if(r<=127)t.push(r);else if(r<=2047)t.push(192|r>>6,128|r&63);else if((r&64512)===55296)if(!(n<e.length-1&&(e.charCodeAt(n+1)&64512)===56320))t.push(239,191,189);else{const o=r,s=e.charCodeAt(++n);r=65536|(o&1023)<<10|s&1023,t.push(240|r>>18,128|r>>12&63,128|r>>6&63,128|r&63)}else(r&64512)===56320?t.push(239,191,189):t.push(224|r>>12,128|r>>6&63,128|r&63)}return new Uint8Array(t)}function AE(e){let t;try{t=decodeURIComponent(e)}catch{throw Nr(qe.DATA_URL,"Malformed data URL.")}return Ip(t)}function Tp(e,t){switch(e){case qe.BASE64:{const i=t.indexOf("-")!==-1,o=t.indexOf("_")!==-1;if(i||o)throw Nr(e,"Invalid character '"+(i?"-":"_")+"' found: is it base64url encoded?");break}case qe.BASE64URL:{const i=t.indexOf("+")!==-1,o=t.indexOf("/")!==-1;if(i||o)throw Nr(e,"Invalid character '"+(i?"+":"/")+"' found: is it base64 encoded?");t=t.replace(/-/g,"+").replace(/_/g,"/");break}}let n;try{n=NE(t)}catch(i){throw i.message.includes("polyfill")?i:Nr(e,"Invalid character found")}const r=new Uint8Array(n.length);for(let i=0;i<n.length;i++)r[i]=n.charCodeAt(i);return r}class Cp{constructor(t){this.base64=!1,this.contentType=null;const n=t.match(/^data:([^,]+)?,/);if(n===null)throw Nr(qe.DATA_URL,"Must be formatted 'data:[<mediatype>][;base64],<data>");const r=n[1]||null;r!=null&&(this.base64=DE(r,";base64"),this.contentType=this.base64?r.substring(0,r.length-7):r),this.rest=t.substring(t.indexOf(",")+1)}}function xE(e){const t=new Cp(e);return t.base64?Tp(qe.BASE64,t.rest):AE(t.rest)}function LE(e){return new Cp(e).contentType}function DE(e,t){return e.length>=t.length?e.substring(e.length-t.length)===t:!1}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class It{constructor(t,n){let r=0,i="";Xc(t)?(this.data_=t,r=t.size,i=t.type):t instanceof ArrayBuffer?(n?this.data_=new Uint8Array(t):(this.data_=new Uint8Array(t.byteLength),this.data_.set(new Uint8Array(t))),r=this.data_.length):t instanceof Uint8Array&&(n?this.data_=t:(this.data_=new Uint8Array(t.length),this.data_.set(t)),r=t.length),this.size_=r,this.type_=i}size(){return this.size_}type(){return this.type_}slice(t,n){if(Xc(this.data_)){const r=this.data_,i=PE(r,t,n);return i===null?null:new It(i)}else{const r=new Uint8Array(this.data_.buffer,t,n-t);return new It(r,!0)}}static getBlob(...t){if(Ja()){const n=t.map(r=>r instanceof It?r.data_:r);return new It(RE.apply(null,n))}else{const n=t.map(s=>Xa(s)?OE(qe.RAW,s).data:s.data_);let r=0;n.forEach(s=>{r+=s.byteLength});const i=new Uint8Array(r);let o=0;return n.forEach(s=>{for(let l=0;l<s.length;l++)i[o++]=s[l]}),new It(i,!0)}}uploadData(){return this.data_}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Za(e){let t;try{t=JSON.parse(e)}catch{return null}return yE(t)?t:null}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function UE(e){if(e.length===0)return null;const t=e.lastIndexOf("/");return t===-1?"":e.slice(0,t)}function ME(e,t){const n=t.split("/").filter(r=>r.length>0).join("/");return e.length===0?n:e+"/"+n}function Rp(e){const t=e.lastIndexOf("/",e.length-2);return t===-1?e:e.slice(t+1)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function FE(e,t){return t}class he{constructor(t,n,r,i){this.server=t,this.local=n||t,this.writable=!!r,this.xform=i||FE}}let Oi=null;function zE(e){return!Xa(e)||e.length<2?e:Rp(e)}function Pp(){if(Oi)return Oi;const e=[];e.push(new he("bucket")),e.push(new he("generation")),e.push(new he("metageneration")),e.push(new he("name","fullPath",!0));function t(o,s){return zE(s)}const n=new he("name");n.xform=t,e.push(n);function r(o,s){return s!==void 0?Number(s):s}const i=new he("size");return i.xform=r,e.push(i),e.push(new he("timeCreated")),e.push(new he("updated")),e.push(new he("md5Hash",null,!0)),e.push(new he("cacheControl",null,!0)),e.push(new he("contentDisposition",null,!0)),e.push(new he("contentEncoding",null,!0)),e.push(new he("contentLanguage",null,!0)),e.push(new he("contentType",null,!0)),e.push(new he("metadata","customMetadata",!0)),Oi=e,Oi}function bE(e,t){function n(){const r=e.bucket,i=e.fullPath,o=new me(r,i);return t._makeStorageReference(o)}Object.defineProperty(e,"ref",{get:n})}function BE(e,t,n){const r={};r.type="file";const i=n.length;for(let o=0;o<i;o++){const s=n[o];r[s.local]=s.xform(r,t[s.server])}return bE(r,e),r}function Np(e,t,n){const r=Za(t);return r===null?null:BE(e,r,n)}function jE(e,t,n,r){const i=Za(t);if(i===null||!Xa(i.downloadTokens))return null;const o=i.downloadTokens;if(o.length===0)return null;const s=encodeURIComponent;return o.split(",").map(u=>{const d=e.bucket,f=e.fullPath,m="/b/"+s(d)+"/o/"+s(f),v=Jo(m,n,r),y=kp({alt:"media",token:u});return v+y})[0]}function $E(e,t){const n={},r=t.length;for(let i=0;i<r;i++){const o=t[i];o.writable&&(n[o.server]=e[o.local])}return JSON.stringify(n)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Jc="prefixes",Zc="items";function VE(e,t,n){const r={prefixes:[],items:[],nextPageToken:n.nextPageToken};if(n[Jc])for(const i of n[Jc]){const o=i.replace(/\/$/,""),s=e._makeStorageReference(new me(t,o));r.prefixes.push(s)}if(n[Zc])for(const i of n[Zc]){const o=e._makeStorageReference(new me(t,i.name));r.items.push(o)}return r}function HE(e,t,n){const r=Za(n);return r===null?null:VE(e,t,r)}class eu{constructor(t,n,r,i){this.url=t,this.method=n,this.handler=r,this.timeout=i,this.urlParams={},this.headers={},this.body=null,this.errorHandler=null,this.progressCallback=null,this.successCodes=[200],this.additionalRetryCodes=[]}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function tu(e){if(!e)throw Ya()}function WE(e,t){function n(r,i){const o=Np(e,i,t);return tu(o!==null),o}return n}function KE(e,t){function n(r,i){const o=HE(e,t,i);return tu(o!==null),o}return n}function GE(e,t){function n(r,i){const o=Np(e,i,t);return tu(o!==null),jE(o,i,e.host,e._protocol)}return n}function nu(e){function t(n,r){let i;return n.getStatus()===401?n.getErrorText().includes("Firebase App Check token is invalid")?i=rE():i=nE():n.getStatus()===402?i=tE(e.bucket):n.getStatus()===403?i=iE(e.path):i=r,i.status=n.getStatus(),i.serverResponse=r.serverResponse,i}return t}function QE(e){const t=nu(e);function n(r,i){let o=t(r,i);return r.getStatus()===404&&(o=eE(e.path)),o.serverResponse=i.serverResponse,o}return n}function qE(e,t,n,r,i){const o={};t.isRoot?o.prefix="":o.prefix=t.path+"/",n&&n.length>0&&(o.delimiter=n),r&&(o.pageToken=r),i&&(o.maxResults=i);const s=t.bucketOnlyServerUrl(),l=Jo(s,e.host,e._protocol),a="GET",u=e.maxOperationRetryTime,d=new eu(l,a,KE(e,t.bucket),u);return d.urlParams=o,d.errorHandler=nu(t),d}function YE(e,t,n){const r=t.fullServerUrl(),i=Jo(r,e.host,e._protocol),o="GET",s=e.maxOperationRetryTime,l=new eu(i,o,GE(e,n),s);return l.errorHandler=QE(t),l}function XE(e,t){return e&&e.contentType||t&&t.type()||"application/octet-stream"}function JE(e,t,n){const r=Object.assign({},n);return r.fullPath=e.path,r.size=t.size(),r.contentType||(r.contentType=XE(null,t)),r}function ZE(e,t,n,r,i){const o=t.bucketOnlyServerUrl(),s={"X-Goog-Upload-Protocol":"multipart"};function l(){let p="";for(let g=0;g<2;g++)p=p+Math.random().toString().slice(2);return p}const a=l();s["Content-Type"]="multipart/related; boundary="+a;const u=JE(t,r,i),d=$E(u,n),f="--"+a+`\r
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class hn{constructor(t,n){this._service=t,n instanceof me?this._location=n:this._location=me.makeFromUrl(n,t.host)}toString(){return"gs://"+this._location.bucket+"/"+this._location.path}_newRef(t,n){return new hn(t,n)}get root(){const t=new me(this._location.bucket,"");return this._newRef(this._service,t)}get bucket(){return this._location.bucket}get fullPath(){return this._location.path}get name(){return Rp(this._location.path)}get storage(){return this._service}get parent(){const t=UE(this._location.path);if(t===null)return null;const n=new me(this._location.bucket,t);return new hn(this._service,n)}_throwIfRoot(t){if(this._location.path==="")throw hE(t)}}function n1(e,t,n){e._throwIfRoot("uploadBytes");const r=ZE(e.storage,e._location,Pp(),new It(t,!0),n);return e.storage.makeRequestWithTokens(r,ru).then(i=>({metadata:i,ref:e}))}function r1(e){const t={prefixes:[],items:[]};return Op(e,t).then(()=>t)}async function Op(e,t,n){const i=await i1(e,{pageToken:n});t.prefixes.push(...i.prefixes),t.items.push(...i.items),i.nextPageToken!=null&&await Op(e,t,i.nextPageToken)}function i1(e,t){t!=null&&typeof t.maxResults=="number"&&$l("options.maxResults",1,1e3,t.maxResults);const n=t||{},r=qE(e.storage,e._location,"/",n.pageToken,n.maxResults);return e.storage.makeRequestWithTokens(r,ru)}function o1(e){e._throwIfRoot("getDownloadURL");const t=YE(e.storage,e._location,Pp());return e.storage.makeRequestWithTokens(t,ru).then(n=>{if(n===null)throw dE();return n})}function s1(e,t){const n=ME(e._location.path,t),r=new me(e._location.bucket,n);return new hn(e.storage,r)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function l1(e){return/^[A-Za-z]+:\/\//.test(e)}function a1(e,t){return new hn(e,t)}function Ap(e,t){if(e instanceof iu){const n=e;if(n._bucket==null)throw uE();const r=new hn(n,n._bucket);return t!=null?Ap(r,t):r}else return t!==void 0?s1(e,t):e}function u1(e,t){if(t&&l1(t)){if(e instanceof iu)return a1(e,t);throw jl("To use ref(service, url), the first argument must be a Storage instance.")}else return Ap(e,t)}function ed(e,t){const n=t==null?void 0:t[Ep];return n==null?null:me.makeFromBucketSpec(n,e)}function c1(e,t,n,r={}){e.host=`${t}:${n}`,e._protocol="http";const{mockUserToken:i}=r;i&&(e._overrideAuthToken=typeof i=="string"?i:hy(i,e.app.options.projectId))}class iu{constructor(t,n,r,i,o){this.app=t,this._authProvider=n,this._appCheckProvider=r,this._url=i,this._firebaseVersion=o,this._bucket=null,this._host=wp,this._protocol="https",this._appId=null,this._deleted=!1,this._maxOperationRetryTime=Jw,this._maxUploadRetryTime=Zw,this._requests=new Set,i!=null?this._bucket=me.makeFromBucketSpec(i,this._host):this._bucket=ed(this._host,this.app.options)}get host(){return this._host}set host(t){this._host=t,this._url!=null?this._bucket=me.makeFromBucketSpec(this._url,t):this._bucket=ed(t,this.app.options)}get maxUploadRetryTime(){return this._maxUploadRetryTime}set maxUploadRetryTime(t){$l("time",0,Number.POSITIVE_INFINITY,t),this._maxUploadRetryTime=t}get maxOperationRetryTime(){return this._maxOperationRetryTime}set maxOperationRetryTime(t){$l("time",0,Number.POSITIVE_INFINITY,t),this._maxOperationRetryTime=t}async _getAuthToken(){if(this._overrideAuthToken)return this._overrideAuthToken;const t=this._authProvider.getImmediate({optional:!0});if(t){const n=await t.getToken();if(n!==null)return n.accessToken}return null}async _getAppCheckToken(){const t=this._appCheckProvider.getImmediate({optional:!0});return t?(await t.getToken()).token:null}_delete(){return this._deleted||(this._deleted=!0,this._requests.forEach(t=>t.cancel()),this._requests.clear()),Promise.resolve()}_makeStorageReference(t){return new hn(this,t)}_makeRequest(t,n,r,i,o=!0){if(this._deleted)return new pE(Sp());{const s=TE(t,this._appId,r,i,n,this._firebaseVersion,o);return this._requests.add(s),s.getPromise().then(()=>this._requests.delete(s),()=>this._requests.delete(s)),s}}async makeRequestWithTokens(t,n){const[r,i]=await Promise.all([this._getAuthToken(),this._getAppCheckToken()]);return this._makeRequest(t,n,r,i).getPromise()}}const td="@firebase/storage",nd="0.12.1";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const xp="storage";function d1(e,t,n){return e=Ie(e),n1(e,t,n)}function f1(e){return e=Ie(e),r1(e)}function h1(e){return e=Ie(e),o1(e)}function Lp(e,t){return e=Ie(e),u1(e,t)}function p1(e=Bh(),t){e=Ie(e);const r=Ba(e,xp).getImmediate({identifier:t}),i=dy("storage");return i&&m1(r,...i),r}function m1(e,t,n,r={}){c1(e,t,n,r)}function g1(e,{instanceIdentifier:t}){const n=e.getProvider("app").getImmediate(),r=e.getProvider("auth-internal"),i=e.getProvider("app-check-internal");return new iu(n,r,i,t,Zn)}function v1(){Kn(new cn(xp,g1,"PUBLIC").setMultipleInstances(!0)),zt(td,nd,""),zt(td,nd,"esm2017")}v1();const y1={apiKey:"AIzaSyA9yec2KfKwvT5sGEllKXuOc1EqtImcHmE",authDomain:"imagebox-cf01d.firebaseapp.com",projectId:"imagebox-cf01d",storageBucket:"imagebox-cf01d.appspot.com",messagingSenderId:"912457187488",appId:"1:912457187488:web:5223e88e76917f5ed509c5"},_1=bh(y1),Dp=p1(_1);let Ai;const w1=new Uint8Array(16);function E1(){if(!Ai&&(Ai=typeof crypto<"u"&&crypto.getRandomValues&&crypto.getRandomValues.bind(crypto),!Ai))throw new Error("crypto.getRandomValues() not supported. See https://github.com/uuidjs/uuid#getrandomvalues-not-supported");return Ai(w1)}const ie=[];for(let e=0;e<256;++e)ie.push((e+256).toString(16).slice(1));function S1(e,t=0){return ie[e[t+0]]+ie[e[t+1]]+ie[e[t+2]]+ie[e[t+3]]+"-"+ie[e[t+4]]+ie[e[t+5]]+"-"+ie[e[t+6]]+ie[e[t+7]]+"-"+ie[e[t+8]]+ie[e[t+9]]+"-"+ie[e[t+10]]+ie[e[t+11]]+ie[e[t+12]]+ie[e[t+13]]+ie[e[t+14]]+ie[e[t+15]]}const k1=typeof crypto<"u"&&crypto.randomUUID&&crypto.randomUUID.bind(crypto),rd={randomUUID:k1};function I1(e,t,n){if(rd.randomUUID&&!t&&!e)return rd.randomUUID();e=e||{};const r=e.random||(e.rng||E1)();if(r[6]=r[6]&15|64,r[8]=r[8]&63|128,t){n=n||0;for(let i=0;i<16;++i)t[n+i]=r[i];return t}return S1(r)}function T1(){const[e,t]=T.useState(""),[n,r]=T.useState(""),[i,o]=T.useState(""),s=async l=>{l.preventDefault();try{const a=_p(),u=await x_(a,e,n);console.log("Login successful:",u.user.uid),o(""),window.location.href="/"}catch(a){o(a.message),console.error("Login error:",a.message)}};return A.jsx("div",{className:"body-1",children:A.jsxs("div",{className:"login-box",style:{textAlign:"center",marginTop:"50px"},children:[A.jsx("h2",{children:"Login Page"}),A.jsxs("form",{onSubmit:s,className:"form",children:[A.jsx("input",{type:"email",placeholder:"Email",value:e,onChange:l=>t(l.target.value),required:!0}),A.jsx("br",{}),A.jsx("input",{type:"password",placeholder:"Password",value:n,onChange:l=>r(l.target.value),required:!0}),A.jsx("br",{}),A.jsx("button",{className:"btn",type:"submit",children:"Login"})]}),i&&A.jsx("p",{style:{color:"red"},children:i})]})})}function C1(){const[e,t]=T.useState(null),n=d=>{t(d.target.files[0])},[r,i]=T.useState(null),o=_p();T.useEffect(()=>{const d=U_(o,f=>{i(f)});return()=>{d()}},[]);const s=()=>{r?l():u()},l=()=>{if(e!==null){const d=Lp(Dp,`files/${I1()}`);d1(d,e).then(f=>{console.log(f),t(null),window.location.reload(),M_(o)})}else console.log("null")},a=zv(),u=()=>{a("/Login"),console.log("Login")};return A.jsx("div",{children:A.jsxs("nav",{children:[A.jsx("div",{className:"logo",children:A.jsx("a",{href:"/",children:A.jsx("h1",{children:"ImageBox"})})}),A.jsxs("div",{className:"choose-file",children:[A.jsx("input",{className:"fileInput",id:"fileInput",type:"file",accept:"image/*",multiple:!0,onChange:n}),A.jsx("img",{src:qw,className:"select",id:"select"})]}),A.jsx("div",{className:"btn-div",children:A.jsx("button",{className:"btn",onClick:s,children:r?"Upload":"Login"})})]})})}const R1=()=>{const[e,t]=T.useState([]);T.useEffect(()=>{f1(Lp(Dp,"files/")).then(l=>{Promise.all(l.items.map(a=>h1(a))).then(a=>{t(a)}).catch(a=>{console.log("Error fetching download URLs:",a)})})},[]);const[n,r]=T.useState(!1),[i,o]=T.useState(""),s=l=>{o(l),r(!0)};return A.jsxs("div",{className:"body-2",children:[A.jsx("div",{className:n?"model open":"model",onClick:()=>r(!1),children:A.jsx("img",{src:i})}),A.jsx("div",{className:"gallery",children:e.map((l,a)=>A.jsx("div",{className:"pics",onClick:()=>s(l),children:A.jsx("img",{src:l,width:"100%"})},a))})]})};function P1(){return A.jsx("div",{children:A.jsxs(ey,{children:[A.jsx(xl,{path:"/",element:A.jsx(A.Fragment,{children:A.jsxs("div",{className:"contain",children:[A.jsx(C1,{}),A.jsx(R1,{})]})})}),A.jsx(xl,{path:"/Login",element:A.jsx(T1,{})})]})})}zs.createRoot(document.getElementById("root")).render(A.jsx(hd.StrictMode,{children:A.jsx(ry,{basename:"/ImageBox",children:A.jsx(P1,{})})}));
